...
CKEDITOR.editorConfig = function( config ) {
	...
	config.allowedContent = 'a[!href]; ul; li; ol; strong; em; table; tbody; thead; tfoot; th[colspan,rowspan]; tr[colspan,rowspan]; td[colspan,rowspan]; p{text-align}; u; strike; sub; sup; iframe[*];'; //keep special styles on re-edition
};
