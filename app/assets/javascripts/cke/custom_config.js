...
CKEDITOR.editorConfig = function( config ) {
	...
	config.allowedContent = 'a[!href]; ul; li; ol; strong; em; table; tbody; thead; tfoot; th[rowspan,colspan]; tr[rowspan,colspan]; td[rowspan,colspan]; p{text-align}; u; strike; sub; sup; iframe[*]; blockquote'; //keep special styles on re-edition
};
